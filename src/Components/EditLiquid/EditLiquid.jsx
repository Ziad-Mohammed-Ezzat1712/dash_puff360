...
export default function EditLiquid({ editItem, onClose, refreshProducts }) {
  ...
  useEffect(() => {
    ...
    setProductData({
      ...
      description_ar: editItem.data?.description_ar || "",
                  category_en: editItem.data?.category_en || "liquid",
      category_ar: editItem.data?.category_ar || "ليكويد",
    ...
    setVariants(
      editItem.liquid?.length
        ? editItem.liquid.map((v) => ({
