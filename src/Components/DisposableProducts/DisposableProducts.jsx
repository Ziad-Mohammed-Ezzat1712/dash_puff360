...
import EditDisposable from "../EditDisposable/EditDisposable";
...
export default function DisposableProducts() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-6">Disposable Products Dashboard</h1>

      {loading ? (
        <p>Loading...</p>
      ) : (
        <DisposableTable products={products} onEdit={openEditPopup} onDelete={handleDelete} />
      )}
