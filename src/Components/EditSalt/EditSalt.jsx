...
export default function EditSalt({ editItem, onClose, refreshProducts }) {
  ...
  useEffect(() => {
    ...
    setProductData({
      ...
      description_ar: editItem.data?.description_ar || "",
                  category_en: editItem.data?.category_en || "Salt",
      category_ar: editItem.data?.category_ar || "Salt",
